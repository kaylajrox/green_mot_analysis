...
top = 400  # vertical height start (top edge)
bottom = 850  # vertical height end (bottom edge)
left = 910  # horizontal width start point (left edge)
right = 1350  # horizontal width end point (right edge)
...
recaptured_mot_folder = os.path.join(base_directory, 'data', '20250114_release_and_recapture_greenMOT', 'recaptured MOT')
...
#
#
# folder_path = "data/20250114_release_and_recapture_greenMOT/recaptured MOT" # Folder path for .h5 files
# dataset_path = 'images/cam1/after ramp/frame'  # Path to dataset inside the .h5 file
#
#
# # starts MUST be a lower number than the end
# top = 550  # vertical height start (top edge)
# bottom = 850  # vertical height end (bottom edge)
# left = 910  # horizontontal width start point (left edge)
# right = 1310  # horizontontal width end point (right edge)
#
# # Ensure interactive mode is off
# plt.ioff()  # Disable interactive mode
#
